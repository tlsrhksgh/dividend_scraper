...
import com.single.project.model.constants.Month;
...
public class YahooFinanceScraper implements Scraper{
    ...
    private static final String STATISTICS_URL = "https://finance.yahoo.com/quote/%s/history?period1=%d&period2=%d&filter=div&frequency=1mo";
    ...
    public ScrapedResult scrap(Company company) {
        ...
        try {
            ...
            scrapResult = ScrapedResult.builder()
                    .company(company)
                    .dividends(dividends)
                    .build();
